...
{
    public class CreateLeaderboardView
    {
        private ILeaderboardViewRepository _leaderboardViewRepository;
        ...
        {
            var existingLeaderBoard = _leaderboardViewRepository.GetLeaderboardView();
